...
namespace Syncfusion.Windows.Forms.Diagram
{
	...
	/// <seealso cref="Syncfusion.Windows.Forms.Diagram.Line"/>
	/// </remarks>
	public class LineTool : Tool, IMouseEventReceiver
	{
		/// <summary>
		/// 
		/// </summary>
		public LineTool() : base(Resources.Strings.Toolnames.Get("LineTool"))
		{
		}
		...
		void IMouseEventReceiver.MouseUp(System.Windows.Forms.MouseEventArgs e)
		{
			if (this.Active && this.drawing)
			{
				...
				if (this.startingPoint != ptEnd)
				{
					...
					Syncfusion.Windows.Forms.Diagram.Line lineShape = new Syncfusion.Windows.Forms.Diagram.Line(worldPts);
					InsertNodesCmd cmd = new InsertNodesCmd();
					cmd.Nodes.Add(lineShape);
