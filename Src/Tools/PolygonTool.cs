...
namespace Syncfusion.Windows.Forms.Diagram
{
	...
	/// </remarks>
	public class PolygonTool : Tool, IMouseEventReceiver, IClickEventReceiver
	{
		/// <summary>
		/// 
		/// </summary>
		public PolygonTool() : base(Resources.Strings.Toolnames.Get("PolygonTool"))
		{
		}
		...
		void IMouseEventReceiver.MouseMove(System.Windows.Forms.MouseEventArgs e)
		{
			if (this.Active && this.tracking)
			{
				...
				Controller.View.DrawTrackingPolygon(trackingPts);
			}
		}
		...
		void IClickEventReceiver.DoubleClick()
		{
			if (this.Active && this.drawing)
			{
				...
				Syncfusion.Windows.Forms.Diagram.Polygon polygonShape = new Syncfusion.Windows.Forms.Diagram.Polygon(worldPts);
				InsertNodesCmd cmd = new InsertNodesCmd();
				cmd.Nodes.Add(polygonShape);
